...
public class DoctorActivity extends AppCompatActivity {
    ...
    private void setupImageGrid (ArrayList<String> imgUrls, ArrayList<String> mediUrls) {
        ListView listView = findViewById(R.id.listView);

        int gridWidgth = getResources().getDisplayMetrics().widthPixels;
        int imageWidth = gridWidgth / NUM_GRID_COLUMN;

        GridImageAdapter gridImageAdapter = new GridImageAdapter(mContext, R.layout.layout_grid_imageview, "https://", imgUrls, mediUrls);
